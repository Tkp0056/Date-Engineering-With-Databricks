## 🚀 End-to-End Data Engineering Project: FMCG Domain (Databricks Free Edition) 📊
...
Bronze Layer (Raw Data): Data is loaded from S3 into the Bronze layer in Databricks without transformations, maintaining raw format.
Silver Layer (Cleaned Data): Data cleaning and standardization are performed (e.g., currency conversion, handling nulls, duplicates).
Gold Layer (BI Ready Data): Aggregated and derived columns are generated, creating BI-ready datasets.
Merge: The Sports Bar's Gold layer data is merged with Atlon's existing Gold layer to provide a unified view.
Reporting: BI dashboards are built on this consolidated Gold layer.
Data Timeline:
